...
import {
    StyleSheet, Text, View, Dimensions, Alert, StatusBar, TouchableOpacity
} from 'react-native';
import {
    Button, Item, Input, Container, Header, Left, Body, Title, Right, Tabs, Tab,
    Thumbnail, Switch, Content, Card, CardItem
} from 'native-base';
